...
<body class="bg-gray-100 pt-[118px]">
    <div class="flex flex-col">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4">
                <div class="bg-green-400 p-12 text-center hover:bg-green-600 rounded-lg shadow-md">
                    <h1 class="text-xl">Ikan dan Kentang</h1>
                    <h1>Rp.30.000</h1>
                    <input type="button" value="Tersedia" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    <br>
                    <input type="button" value="Tidak Tersedia" class="mt-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">
                </div>
                <div class="bg-yellow-400 p-12 text-center hover:bg-yellow-600 rounded-lg shadow-md">
                    <h1 class="text-xl">Garam dan Madu</h1>
                    <h1>Rp.30.000</h1>
                    <input type="button" value="Tersedia" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    <br>
                    <input type="button" value="Tidak Tersedia" class="mt-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">
                ...
                <div class="bg-blue-400 p-12 text-center hover:bg-blue-600 rounded-lg shadow-md">
                    <h1 class="text-xl">Jeruk Hangat</h1>
                    <h1>Rp.30.000</h1>
                    <input type="button" value="Tersedia" class="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    <br>
                    <input type="button" value="Tidak Tersedia" class="mt-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">
